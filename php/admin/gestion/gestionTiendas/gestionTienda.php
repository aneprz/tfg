...
<head>
    ...
    <title>SalsaBox - Administracion Tienda</title>
...
<body>
    ...
    <div class="central">
        ...
        <div class="admin-grid">
            ...
            <a href="añadirItem/añadirItem.php" class="admin-card">
                <div class="card-icon">➕🛒</div>
                <span>Añadir Item</span>
            </a>

            <a href="eliminarItem/eliminarItem.php" class="admin-card">
                <div class="card-icon">🗑️🛒</div>
                <span>Eliminar Item</span>
            </a>

            <a href="editarItem/listaEditarItem.php" class="admin-card">
                <div class="card-icon">✏️🛒</div>
            ...
            <a href="eliminarLootbox/eliminarLootbox.php" class="admin-card">
                <div class="card-icon">🗑️🎁</div>
                <span>Eliminar lootbox</span>
            </a>
